    ...
    return (
        <div className="max-w-lg w-full mx-auto my-12 bg-[#13131f]/90 backdrop-blur-sm rounded-3xl shadow-xl shadow-purple-900/30 overflow-hidden border border-purple-800/30">
            <div className="bg-gradient-to-r from-[#1a0a2e] via-[#2d0a3e] to-[#0d0d1a] px-6 py-6 text-center text-white shadow-sm border-b border-purple-800/30">
                <h2 className="text-2xl font-bold drop-shadow-sm font-mono">Crear una Cuenta</h2>
            ...
            <form onSubmit={handleSubmit} className="px-6 py-8 space-y-4">
                ...
                {success && (
                    <div className="bg-emerald-950/40 text-emerald-300 p-4 rounded-2xl flex items-start gap-2.5 border border-emerald-800/40 text-sm shadow-sm">
                ...
                <div>
                    <label className="block text-sm font-semibold text-purple-200 mb-1">Nombre Completo</label>
                ...
                <div>
                    <label className="block text-sm font-semibold text-purple-200 mb-1">Correo electrónico</label>
                    <div className="relative">
                ...
                <div>
                    <label className="block text-sm font-semibold text-purple-200 mb-1">Contraseña</label>
                    <div className="relative">
                ...
                <div className="space-y-4 border-t border-purple-800/30 pt-4">
                    <h3 className="text-xs font-bold text-purple-400 uppercase tracking-wider">Información Adicional</h3>

                    <div>
                        <label className="block text-sm font-semibold text-purple-200 mb-1">Teléfono de contacto</label>
                        <div className="relative">
                    ...
                    <div>
                        <label className="block text-sm font-semibold text-purple-200 mb-1">Dirección</label>
                        <div className="relative">
                            <MapPin size={18} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-purple-400" />
                            <input
                                type="text"
                                value={direccion}
                ...
                <button
                    type="submit"
                    disabled={loading}
                    className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-[#a855f7] to-[#f472b6] hover:from-[#7c3aed] hover:to-[#ec4899] text-white font-bold py-3 rounded-2xl shadow-md shadow-purple-900/30 transition-all duration-200 cursor-pointer disabled:opacity-50 mt-2"
                >
